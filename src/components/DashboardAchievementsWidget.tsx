    ...
    <div className="h-full flex flex-col justify-between bg-gradient-to-br from-slate-900 via-[#121927] to-slate-900 text-white border border-slate-800 p-4 sm:p-5 rounded-2xl shadow-md relative overflow-hidden gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 relative z-10">
        ...
        <div className="flex items-center space-x-3 min-w-0">
          <RankAvatar rank={rank} size="md" className="shrink-0" />
        ...
        <div className="flex items-center justify-between sm:justify-end space-x-2 shrink-0">
          <div className="px-2.5 py-1 rounded-xl bg-slate-800/90 border border-slate-700/80">
            ...
            <div className="text-xs font-black text-amber-400 font-mono flex items-center space-x-0.5">
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-slate-950 text-xs font-black flex items-center space-x-1.5 transition-all shadow-xs cursor-pointer whitespace-nowrap active:scale-95"
          >
      ...
      <div className="bg-slate-800/50 border border-slate-700/60 p-3 sm:p-3.5 rounded-xl space-y-2 relative z-10 my-auto">
        <div className="flex items-center justify-between text-xs gap-2">
          <div className="font-extrabold text-slate-200 flex items-center space-x-1.5 truncate min-w-0">
        ...
        {rank.level < 10 && (
          <div className="text-[11px] text-slate-400 font-medium truncate flex items-center space-x-1 pt-0.5">
            <span>След:</span>
            <strong className="text-white font-bold">{nextRank.title}</strong>
            <span className="text-slate-400 font-mono text-[10px]">({xpSpanInRank - currentXPInRank} XP)</span>
          </div>
        )}
      </div>
